...
// GET /api/admin/applications  — full Film School registry for the owner.
// Every child + contact record is decrypted here, server-side, only for an
// authenticated admin. The data is never sent to anyone who isn't signed in.
